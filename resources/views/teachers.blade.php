...
<head>
    ...
    <script defer src="{{ mix('js/teachers/entry-client.js') }}"></script>
</head>
<body class="bg-paper font-sans leading-normal text-grey-darkest border-t-4 border-orange-light"><p>test</p>
{!! ssr('js/teachers/entry-server.js')
